        ...
        <div className="bg-whiteone min-w-screen min-h-screen relative overflow-hidden">
             <motion.div animate={{
                ...
                <div className="absolute top-[50%] left-[50%] translate-x-[-50%] translate-y-[-50%]">
                    <motion.img whileHover={{rotate:180}} alt = "Upper Filled" src={upper_semi_fill} className="relative"/>
                    <motion.img whileHover={{rotate:180}} alt = "Lower Filled" src={lower_semi_fill} className="relative"/>
                </div>
