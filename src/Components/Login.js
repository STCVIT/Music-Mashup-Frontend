    ...
    return (
        <div>
            ...
            <div className="h-screen w-screen relative z-10 text-whiteone overflow-hidden flex flex-col justify-center items-center">
                ...
                {/* <Link to='../LandingTwo'> */}
                    <motion.div whileTap={{ scale: 0.9 }} className="absolute right-[1rem] top-[1rem] max-w-[3rem] z-[20]"><img src={user} alt="" /></motion.div>
                {/* </Link> */}

                <div className="text-[3rem] mb-[1rem]">Welcome Back</div>
                <button onClick={handleGoogleSignIn}
                    className="flex flex-row justify-center items-center border-solid my-[1rem] border-whiteone border-2 rounded-[10px] w-[50%] px-[1.2rem] py-[0.5rem] hover:bg-whiteone hover:text-blackone transition ease-in-out"><img className="mx-[0.5rem] w-[1rem]" src={google} />Sign in with Google</button>
                or
