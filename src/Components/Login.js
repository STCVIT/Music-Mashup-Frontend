    ...
    return (
        <div>
            ...
            <Link to='../LandingTwo'>
                ...
                <button className="border-solid border-whiteone text-blackone bg-whiteone border-2 rounded-[10px] w-full px-[1.2rem] py-[0.5rem] my-[1rem] font-bold">Sign In</button>
            </form>
