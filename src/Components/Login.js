        ...
        <div>
            ...
            <div className="h-screen w-screen relative z-10 text-whiteone overflow-hidden flex flex-col justify-center items-center">
                ...
                <button onClick={handleGoogleSignIn}
                    className="flex flex-row justify-center items-center border-solid my-[1rem] border-whiteone border-2 rounded-[10px] w-[30%] px-[1.2rem] py-[0.5rem] hover:bg-whiteone hover:text-blackone transition ease-in-out"><img className="mx-[0.5rem] w-[1rem]" src={google} />Sign in with Google</button>
                or
                    ...
                    <div className='relative w-full bg-blackone'>
                        ...
                        <div className='relative w-full bg-blackone'>
                            <input
                                ...
                                <Link to="../ResetPassword" className="text-[0.8rem] align-top ml-[80%]">Reset Password</Link>
                                <img alt="Show Password" className="password_eye absolute max-w-[1.5rem] top-[30%] right-[20px] " src={not_seen} onClick={handlePasswordEye}/>
                        </div>
