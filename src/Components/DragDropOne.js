    ...
    <div>
      ...
      <div className="bg-blackone min-w-screen min-h-screen relative overflow-hidden">
        ...
        <div className="absolute top-[50%] left-[50%] translate-x-[-50%] translate-y-[-50%] border-2 rounded-lg min-h-[60%] w-[50%] text-whiteone p-5">
          ...
          <form className="bg-whiteone text-blackone px-[0.5rem] py-[0.5rem] my-[2%] rounded-lg flex flex-wrap">
            <img
              src={search_black}
          ...
          <div className="flex flex-col align-middle text-center justify-center">
            ...
            <button
              onClick={uploadAudio}              
              className="my-5 mx-[40%] border-whiteone border-2 hover:bg-whiteone hover:text-blackone rounded-lg px-2 py-1 text-white font-bold"
            >
              Upload Audio
            </button>
          </div>
