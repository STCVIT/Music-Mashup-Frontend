...
export default function MusicPlayingOne() {
    ...
    return (
        <div className="bg-blackone min-w-screen min-h-screen relative overflow-hidden">
            ...
            <img src={playing_discard_btn} className="absolute top-[50%] left-[20%] translate-y-[-50%] max-w-[7rem]" alt=""/>
            <img src={playing_download_btn} className="absolute top-[50%] right-[20%] translate-y-[-50%] max-w-[7rem]" alt=""/>
            <img src={playing_btn} className="absolute top-[50%] left-[50%] translate-x-[-50%] translate-y-[-50%]" alt=""/>
